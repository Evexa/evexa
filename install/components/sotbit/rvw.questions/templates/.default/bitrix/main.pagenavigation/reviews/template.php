...
$sort = '';
if ($request['action'] == 'contentLoader') {
    $sort = '&DATE_CREATION=' . $request['DATE_CREATION'] . '&RATING=' . $request['RATING'] . '&FILES=' . $request['FILES'].'&tab='.$request['active'];
    $arResult["URL"] .= $sort;
    $arResult["URL_TEMPLATE"] .= $sort;
}
?>
