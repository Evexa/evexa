...
class Reviews extends CBitrixComponent implements Controllerable, \Bitrix\Main\Errorable
{
    ...
    public function contentLoaderAction()
    {
        ...
        $obComponentResult = new \Bitrix\Main\Engine\Response\Component('sotbit:rvw.reviews', $this->request->get('templateName') ?? '', $this->arParams);
